...
const (
	...
	KindUnknown             ErrKind = "位置错误"
	KindDatabaseError       ErrKind = "数据库错误"
	KindCommunicationError  ErrKind = "通信错误"
	KindEntityDoesNotExist  ErrKind = "资源不存在"
	KindContractInvalid     ErrKind = "参数错误"
	...
	KindServiceLocked       ErrKind = "服务被锁定"
	KindNotImplemented      ErrKind = "未实现"
	KindRangeNotSatisfiable ErrKind = "遍历失败"
	KindIOError             ErrKind = "IO错误"
	KindOverflowError       ErrKind = "溢出"
	KindNaNError            ErrKind = "NaN"
)
